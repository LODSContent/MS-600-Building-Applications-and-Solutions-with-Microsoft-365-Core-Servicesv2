...
resource botWebAppSettings 'Microsoft.Web/sites/config@2021-02-01' = {
  ...
  properties: union({
    ...
    APPLICATIONINSIGHTS_CONNECTION_STRING:  provisionOutputs.appInsightOutput.value.connectionString // Connection string of application insights
    APPINSIGHTS_INSTRUMENTATIONKEY: provisionOutputs.appInsightOutput.value.instrumentationKey // Instrumentation Key
  }, currentAppSettings)
}
